  ...
  <div class="seller" ref="seller">
    <div class="seller-content">
      <div class="overview">
        ...
        <div class="favorite" @click="toggle"><span class="icon-favorite" :class="{active:favorite}"></span><span class="text"></span>{{favorite ? '已收藏' :'收藏'}}</div>
      </div>
      <split></split>
      ...
      <div class="bulletin">
        ...
        <ul class="supports">
          <li class="support-item border-1px" v-for="support in seller.supports"><span class="icon" :class="classMap[support.type]"> </span><span class="text">{{support.description}}</span></li>
        </ul>
      </div>
  ...
  export default {
    ...
    methods: {
      toggle($event){
        ...
        if(!$event._constructed){//区分better-scroll派发的事件
          return
        }
