<template>
  <div>
    <div class="shopcart">
        <div class="content">
          ...
          <div class="content-right">
            <div class="pay" :class="{enough: totalPrice>= minPrice}">{{payText}}</div>
          </div>
        </div>

        <div class="ball-container">
          <transition v-for="(ball,index) in balls" :key="index" @before-enter="beforeDrop" @enter="dropping" @after-enter="afterDrop" v-bind:css="false">
        ...
        <transition name="fold">
          <div class="shopcart-list" v-show="isShow">
            ...
            <div class="list-content">
              <ul>
                <li class="food" v-for="food in foodList"><span class="name">{{food.name}}/{{food.count}}个</span>
                <div class="price">￥{{food.price}}<span></span></div>
                <div class="cartcontrol-wrapper"><cartcontrol :food="food" :update-food-count="updateFoodCount"></cartcontrol></div></li>
              </ul>
            </div>
          </div>
        </transition>
    ...
    <transition name="fade">
      <div class="list-mask" v-show="isShow" @click="toggleList"></div>
    </transition>
  </div>
</template>
